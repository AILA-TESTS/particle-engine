...
/** Map JSON Schema type strings to Google GenAI SchemaType enum values */
...
/** Convert a JSON Schema property to Google GenAI's Schema format recursively */
...
/** Convert our ToolDefinition[] to Google GenAI's FunctionDeclarationsTool[] format */
export function formatToolsGenAI(tools: ToolDefinition[]): FunctionDeclarationsTool[] {
